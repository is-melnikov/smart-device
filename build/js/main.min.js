...
/* harmony import */ var _modules_modals_show_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/modals/show-accordion */ "./js/modules/modals/show-accordion.js");
/* harmony import */ var _modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modals/phone-mask */ "./js/modules/modals/phone-mask.js");
/* harmony import */ var _modules_modals_tabindex__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/tabindex */ "./js/modules/modals/tabindex.js");
/* harmony import */ var _modules_modals_phone_validate__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/modals/phone-validate */ "./js/modules/modals/phone-validate.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_show_accordion__WEBPACK_IMPORTED_MODULE_3__["showAccordion"])();
  Object(_modules_modals_phone_mask__WEBPACK_IMPORTED_MODULE_4__["createMask"])();
  Object(_modules_modals_tabindex__WEBPACK_IMPORTED_MODULE_5__["editTabindex"])();
  Object(_modules_modals_phone_validate__WEBPACK_IMPORTED_MODULE_6__["phoneValidate"])();
...
var getPrefixNumber = function getPrefixNumber(str) {
  if (str === '7') {
    return '+7 (';
  }
  if (str === '9') {
...
var INPUT_PHONE = document.querySelector('input[data-js="phone-number"]');
var SPAN_ERROR = document.querySelector('span[data-js="show-error"]');
var NUMBER_PHONE_LENGTH = 18;
var phoneValidate = function phoneValidate() {
  var validatePhoneLength = function validatePhoneLength(inputPhone) {
    return inputPhone.value.length >= NUMBER_PHONE_LENGTH;
  };
...
/***/ "./js/modules/modals/show-accordion.js":
/*!*********************************************!*\
  !*** ./js/modules/modals/show-accordion.js ***!
  \*********************************************/
/*! exports provided: showAccordion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showAccordion", function() { return showAccordion; });
var NAVIGATION_ACCORDION = document.querySelector('.footer-navigation');
var CONTACTS_ACCORDION = document.querySelector('.footer-contacts');
var NAVIGATION_LIST = document.querySelector('.footer-navigation__list');
var CONTACTS_LIST = document.querySelector('.footer-contacts__list');
var NAVIGATION_TITLE = document.querySelector('.footer-navigation__title');
var CONTACTS_TITLE = document.querySelector('.footer-contacts__title');
var showAccordion = function showAccordion() {
  ...
  var onNavigationClick = function onNavigationClick() {
  ...
  var onContactsClick = function onContactsClick() {
...
var ABOUT_DESCRIPTION = document.querySelector('.about__description');
...
/***/ "./js/modules/modals/tabindex.js":
/*!***************************************!*\
  !*** ./js/modules/modals/tabindex.js ***!
  \***************************************/
/*! exports provided: editTabindex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "editTabindex", function() { return editTabindex; });
var FOOTER_TITLES = document.querySelectorAll('.footer-title');
var editTabindex = function editTabindex() {
  var onWindowLoadResize = function onWindowLoadResize() {
    FOOTER_TITLES.forEach(function (elem) {
