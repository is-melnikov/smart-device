...
var navigationAccordion = document.querySelector('.footer-navigation');
var contactsAccordion = document.querySelector('.footer-contacts');
...
var navigationTitle = document.querySelector('.footer-navigation__title');
var contactsTitle = document.querySelector('.footer-contacts__title');
...
var aboutDescriptions = document.querySelectorAll('.about__description');
var showMore = function showMore() {
  aboutButton.classList.remove('about__button--nojs');
  aboutDescriptions.forEach(function (aboutDescription) {
